          ...
          <View style={styles.topRow}>
            ...
            <View style={styles.actions}>
              {isMe ? (
                ...
                <Pressable style={styles.primaryButton} onPress={() => router.push(`/messages/${profile.user.username}`)}><Ionicons name="chatbubble-outline" color={colors.bg} size={17} /><Text style={styles.primaryText}>Message</Text></Pressable>
              )}
            </View>
          </View>
          {editing ? (
